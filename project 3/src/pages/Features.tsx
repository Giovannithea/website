...
import { Shield, Filter, Bot, Radio, Brain } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto px-4 py-24">
      <div className="text-center mb-24">
        ...
        <p className="text-2xl text-gray-400">Stop trading blind. Trade with QuickBot.</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
        ...
        <div className="bg-white/5 p-8 rounded-xl md:col-span-2">
