  ...
  return (
    <div className="container mx-auto px-4 py-24">
      <div className="text-center mb-24">
        <h1 className="text-6xl font-bold mb-6">About Us — The Team Behind QuickBot</h1>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="bg-white/5 p-8 rounded-xl text-center">
            ...
            <p className="text-gray-400">Blockchain developer and technical lead. Architecting QuickBot's secure, lightning-fast systems.</p>
          </div>

          <div className="bg-white/5 p-8 rounded-xl text-center">
            <img 
              src="/Assets/1000016781-modified.png" 
              alt="Marco B" 
              className="w-32 h-32 rounded-full mx-auto mb-6 object-cover"
            />
            <h3 className="text-2xl font-bold mb-2">Marco B</h3>
            <p className="text-purple-500 mb-4">CEO & Founder</p>
            <p className="text-gray-400">A veteran trader and strategist. Building QuickBot to help everyday traders compete like professionals.</p>
          </div>

          <div className="bg-white/5 p-8 rounded-xl text-center">
            <img 
              src="/Assets/1000016869-modified.png" 
              alt="Giovanni" 
              className="w-32 h-32 rounded-full mx-auto mb-6 object-cover"
            />
