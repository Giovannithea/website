      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-6">
          <div className="text-center">
            <p className="text-gray-400">QuickBot © 2025 — Built for Solana Traders</p>
          </div>
          ...
          <div className="flex items-center gap-6">
            <a href="mailto:hello@quickbot.ai" className="text-gray-400 hover:text-white">
              Contact us: hello@quickbot.ai
            </a>
          </div>
